	  ...
	  _createClass(CommentBox, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_CommentForm2.default, { onCommentSubmit: function onCommentSubmit(comment) {
	            return _this2.handleCommentSubmit(comment);
	          } })
	      );
	    }
	  }]);
	...
	var Comment = (function (_Component) {
	  ...
	  _createClass(Comment, [{
	    ...
	    value: function rawMarkup() {
	      return {
	        __html: (0, _marked2.default)(this.props.children.toString(), { sanitize: true })
	      };
	    }
	  }, {
	    key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	CommentForm.propTypes = {
	  onCommentSubmit: _react.PropTypes.func.isRequired
	};
